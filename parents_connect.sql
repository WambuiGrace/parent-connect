...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2024 at 02:23 PM
...
CREATE TABLE `articles` (
  ...
  `category` enum('Parenting Basics','Health and Safety','Community Forum') NOT NULL,
...
CREATE TABLE `resources` (
  ...
  `type` enum('Book','Website','Local Service') NOT NULL,
...
--
ALTER TABLE `group_members`
  ADD CONSTRAINT `group_members_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `support_groups` (`id`),
